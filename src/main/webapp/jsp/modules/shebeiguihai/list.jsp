...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">设备归还管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">设备归还管理</li>
								<li class="breadcrumb-item active">设备归还列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">设备归还列表</h3>							
	...
	<script>
			...
			row.appendChild(checkbox)
				  ...
				  tupianCell.appendChild(tupianImg);
									...
									row.appendChild(tupianCell);
				            				var guihaineirongCell  = document.createElement('td');

												  if(item.guihaineirong != null && item.guihaineirong != "" && item.guihaineirong.length >= 11){
				  	guihaineirongCell.innerHTML = item.guihaineirong.substring(0, 10) + "..."; 
				  }else{
				  	guihaineirongCell.innerHTML = item.guihaineirong;
				  }

				
									row.appendChild(guihaineirongCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("shebeiguihai/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("shebeiguihai/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shebeiguihai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shebeiguihai");
