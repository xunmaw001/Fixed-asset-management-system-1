								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<input name="tupian" id="tupian-input" type="hidden">
											...
											<div class="form-group col-md-6">
										<label>归还内容</label>
										<textarea name="guihaineirong" class="form-control" id="guihaineirong" rows="3"></textarea>
									</div>
											<div class="form-group col-md-6">
										<label>归还日期</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("shebeiguihai/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#shebeibianhao").val(ruleForm.shebeibianhao);	
																...
																$("#guihaineirong").val(ruleForm.guihaineirong);
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$("#tupian-input").val(res.data.tupian);
												...
												if(res.data != null && res.data != '' && res.data.guihaineirong != null && res.data.guihaineirong != ''){

															$("#guihaineirong").val(res.data.guihaineirong);
													}
