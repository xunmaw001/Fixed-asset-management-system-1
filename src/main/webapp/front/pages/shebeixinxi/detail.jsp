				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shebeixinxi','领用')" @click="onAcrossTap('shebeilingyong')" type="button" class="layui-btn">
								领用
							</button>
																					<button v-if="isAuth('shebeixinxi','报修')" @click="onAcrossTap('shebeibaoxiu')" type="button" class="layui-btn">
								报修
							</button>
																					<button v-if="isAuth('shebeixinxi','入库')" @click="onAcrossTap('shebeiruku')" type="button" class="layui-btn">
								入库
							</button>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.shebeimingcheng;
																														// 轮播图片
