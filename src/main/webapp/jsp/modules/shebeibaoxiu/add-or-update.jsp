		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑设备报修</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">编辑设备报修</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">设备报修信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="shebeifenlei" name="shebeifenlei" class="form-control" placeholder="设备分类">
											...
											<div class="form-group col-md-6">
										<label>报修内容</label>
										<input id="baoxiuneirong" name="baoxiuneirong" class="form-control" placeholder="报修内容">
									</div>
											<div class="form-group col-md-6">
										<label>日期</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shebeibaoxiu/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shebeibaoxiu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
