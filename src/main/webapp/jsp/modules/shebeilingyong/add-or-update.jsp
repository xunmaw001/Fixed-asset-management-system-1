		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑设备领用</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">设备领用管理</li>
								<li class="breadcrumb-item active">编辑设备领用</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">设备领用信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="beizhu" name="beizhu" class="form-control" placeholder="备注">
											...
											<div class="form-group col-md-6">
										<label>领用日期</label>
										<div id="lingyongriqiDate" class="input-append date form_datetime">
											<input id="lingyongriqi-input" name="lingyongriqi" size="15" type="text" readonly>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shebeilingyong/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shebeilingyong/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shebeilingyong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			$.fn.datetimepicker.dates['zh-CN'] = { 
		            ...
		            meridiem: ["上午", "下午"]
																																														...
																																														$("#lingyongriqiDate").datetimepicker({ 
					minView: "month",
					autoclose: true,
					format:'yyyy-mm-dd',
					language:'zh-CN',
		...
		function calculationSE(colName){
			//单列求和接口
			http("shebeilingyong"+colName,"GET",{
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#shebeibianhao").val(ruleForm.shebeibianhao);	
																...
																$("#lingyongriqi-input").val(ruleForm.lingyongriqi);
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$("#shuliang").val(res.data.shuliang);
												...
												if(res.data != null && res.data != '' && res.data.lingyongriqi != null && res.data.lingyongriqi != ''){

															$("#lingyongriqi-input").val(res.data.lingyongriqi);
								$('#lingyongriqiFileName').val(res.data.lingyongriqi)
													}
