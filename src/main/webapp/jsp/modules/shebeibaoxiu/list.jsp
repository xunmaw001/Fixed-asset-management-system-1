...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">设备报修管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">设备报修管理</li>
								<li class="breadcrumb-item active">设备报修列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">设备报修列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('shebeibianhao')">设备编号<i id="shebeibianhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('baoxiuneirong')">报修内容<i id="baoxiuneirongIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("shebeibaoxiu/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("shebeibaoxiu/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shebeibaoxiu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shebeibaoxiu");
